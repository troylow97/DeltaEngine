...
//Dynamic Collision Checks
	...
	bool CollisionIntersection_CircleCircle(Collider&, const Vector2&, const Collider&, const Vector2&);

	bool CollisionIntersection_RayCircle(const Ray& ray, Collider& col2);

//Main
	bool CollisionIntersection_Main(Collider&,const RigidBody&,Collider&,const RigidBody&);

	bool CollisionIntersection_Sub_Box(Collider&, const RigidBody&,Collider&, const RigidBody&);

	bool CollisionIntersection_Sub_Circle(Collider&, const RigidBody&,Collider&, const RigidBody&);

	bool CollisionIntersection_Sub_Ray(Collider&, const RigidBody&, Collider&, const RigidBody&);

	bool CollisionIntersection_Sub_Line(Collider&,Collider&);
//UNUSED FUNCTIONS
