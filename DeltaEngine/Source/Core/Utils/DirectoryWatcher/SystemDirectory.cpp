...
* \brief  This file contains the implementation for the SystemDirectory
...
namespace DeltaEngine
{
  void Directory::Initialize()
  {
    ...
    for (auto& dir : FileUtils::DirList(cur_dir))
    {
      ...
      DeltaEngine_CORE_TRACE("Sub Directory - {}",
                             str.substr( str.find( FileUtils::Root().filename().generic_string() ) ));
  ...
  void SystemDirectory::Initialize()
  {
    ...
    {
      auto str = dir.path().generic_string();
      DeltaEngine_CORE_TRACE("Main Directory - {}",
                             str.substr( str.find( FileUtils::Root().filename().generic_string() ) ));
