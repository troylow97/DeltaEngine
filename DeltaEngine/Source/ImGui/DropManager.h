...
namespace DeltaEngine
{
  ...
  public:
    ...
    unsigned long AddRef(void) override
    {
      return 1;
    }
    ...
    HRESULT Drop(IDataObject* pDataObj, DWORD grfKeyState, POINTL pt, DWORD* pdwEffect) override
    {
      ...
      *pdwEffect |= DROPEFFECT_COPY;
      ...
      unsigned int fileCount = DragQueryFile(drop, 0xFFFFFFFF, nullptr, 512);
      ...
      for (unsigned int i = 0; i < fileCount; ++i)
      {
        ...
        if (fileNameLength > longestFileNameLength)
        {
          ...
          fileName = static_cast<wchar_t*>(malloc(longestFileNameLength * sizeof(*fileName)));
        }
