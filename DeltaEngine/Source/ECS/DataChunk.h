/**********************************************************************************
* \file   DataChunk.h
* \brief  This file contains the definition of DataChunk
*         Component data are stored as pure bytes in a data chunk using the
*         archetype description to identify the position and type
*
