/**********************************************************************************
* \file   ComponentMeta.h
* \brief  This file contains the implementation for component metadata
*         The data stored is used to identify the bits of each component
*         and the construction / desctruction of each type
*
