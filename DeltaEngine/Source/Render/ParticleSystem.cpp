...
* \brief  The file contains implemantation of ParticleSystem class. Not functional.
...
#pragma region VertexArray class
  ...
  void ParticleSystem::VertexArray::AddBuffer(const VertexBuffer& vb, const VertexBufferLayout& layout)
  {
    ...
    for (unsigned int i = 0; i < elements.size(); ++i)
    {
      ...
      GLCall(
        glVertexAttribPointer( i + vertexAttribArrayCount, element.count, element.type, element.normalized, layout.
