...
namespace DeltaEngine
{
	...
	Camera::Camera() : _size{ 3 }, _zNear{ -10 }, _zFar{ 10 }, cameraIndex{ allCameras.size() }
	{
	...
	{
		return Matrix4x4::Ortho(-_size / RenderModule::height * RenderModule::width, _size / RenderModule::height * RenderModule::width, -_size, _size, _zNear, _zFar);
	}
