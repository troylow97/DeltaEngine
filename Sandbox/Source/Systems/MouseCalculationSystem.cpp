/**********************************************************************************
* \file   MouseCalculationSystem.cpp
...
**********************************************************************************/
#include "MouseCalculationSystem.h"
...
{
  void MouseCalculationSystem::Update()
  {
    ShootLeft();
    ShootRight();
    IsMouseOnRight();
    Profiler::Instance().Record("MouseCalculationSystem System");
  }
  
  void MouseCalculationSystem::LateUpdate()
  {
  }
  
  bool MouseCalculationSystem::ShootRight()
  {
    auto& player_pos = em.GetComponent<Transform>(UnitManager::GetPlayerID());
    auto& player_id = em.GetComponent<EntityID>(UnitManager::GetPlayerID());
  ...
  bool MouseCalculationSystem::ShootLeft()
  {
     auto& player_pos = em.GetComponent<Transform>(UnitManager::GetPlayerID());
     auto& player_id = em.GetComponent<EntityID>(UnitManager::GetPlayerID());
  ...
  bool MouseCalculationSystem::IsMouseOnRight()
  {
  ///////////////  ////// UI system
