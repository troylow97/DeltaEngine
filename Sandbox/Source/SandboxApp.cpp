...
public:
	Sandbox()
	{
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<EntityType>(first).type = EntityCategory::E_PLAYER;
		env.pECS->GetWorld().GetEntityManager().GetComponent<Health>(first).MaxHealth = 500;
		env.pECS->GetWorld().GetEntityManager().GetComponent<Health>(first).CurrentHealth = 500;
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<Transform>(first).position = { -4.0,2.0,0 };
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<RigidBody>(first).FrictionCoeff = 2.0f;
		env.pECS->GetWorld().GetEntityManager().GetComponent<RigidBody>(first).hasGravity = true;
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<AI>(sec).key = "idle_lancer";
		env.pECS->GetWorld().GetEntityManager().GetComponent<AI>(sec).transition = "null";
		env.pECS->GetWorld().GetEntityManager().GetComponent<EntityType>(sec).type = EntityCategory::E_ENEMY;
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<Transform>(sec).position = { 3,2,0 };
...
//WALLS
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<Transform>(third).position = { 0,-5,0 };
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<EntityType>(third).type = EntityCategory::E_WALL;
		...
		env.pECS->GetWorld().GetEntityManager().GetComponent<EntityType>(fourth).type = EntityCategory::E_WALL;
